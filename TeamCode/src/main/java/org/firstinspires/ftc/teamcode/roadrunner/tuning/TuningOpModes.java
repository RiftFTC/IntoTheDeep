...
public final class TuningOpModes {
    ...
    public static void register(OpModeManager manager) {
        ...
        manager.register(metaForClass(SplineTest.class), org.firstinspires.ftc.teamcode.roadrunner.tuning.SplineTest.class);
        manager.register(metaForClass(LocalizationTest.class), org.firstinspires.ftc.teamcode.roadrunner.tuning.LocalizationTest.class);
